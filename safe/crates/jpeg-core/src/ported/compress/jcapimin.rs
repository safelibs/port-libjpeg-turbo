...
pub const CSTATE_SCANNING: ::core::ffi::c_int = 101 as ::core::ffi::c_int;
pub const CSTATE_RAW_OK: ::core::ffi::c_int = 102 as ::core::ffi::c_int;
...
pub unsafe extern "C" fn jpeg_CreateCompress(
    ...
    (*cinfo).mem = ::core::ptr::null_mut::<jpeg_memory_mgr>();
    if version != JPEG_LIB_VERSION {
        (*(*cinfo).err).msg_code = JERR_BAD_LIB_VERSION as ::core::ffi::c_int;
        (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] = 80 as ::core::ffi::c_int;
        (*(*cinfo).err).msg_parm.i[1 as ::core::ffi::c_int as usize] = version;
        Some(
            (*(*cinfo).err)
                .error_exit
    ...
    if structsize != ::core::mem::size_of::<jpeg_compress_struct>() as usize {
        (*(*cinfo).err).msg_code = JERR_BAD_STRUCT_SIZE as ::core::ffi::c_int;
        (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] =
            ::core::mem::size_of::<jpeg_compress_struct>() as ::core::ffi::c_int;
        (*(*cinfo).err).msg_parm.i[1 as ::core::ffi::c_int as usize] =
            structsize as ::core::ffi::c_int;
        Some(
            (*(*cinfo).err)
                .error_exit
                .expect("non-null function pointer"),
    ...
    let mut client_data: *mut ::core::ffi::c_void = (*cinfo).client_data;
    memset(
        cinfo as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<jpeg_compress_struct>() as size_t,
    );
    (*cinfo).err = err;
    (*cinfo).client_data = client_data;
    (*cinfo).is_decompressor = FALSE as boolean;
    jinit_memory_mgr(cinfo as j_common_ptr);
    (*cinfo).progress = ::core::ptr::null_mut::<jpeg_progress_mgr>();
    (*cinfo).dest = ::core::ptr::null_mut::<jpeg_destination_mgr>();
    (*cinfo).comp_info = ::core::ptr::null_mut::<jpeg_component_info>();
    i = 0 as ::core::ffi::c_int;
    while i < NUM_QUANT_TBLS {
        (*cinfo).quant_tbl_ptrs[i as usize] = ::core::ptr::null_mut::<JQUANT_TBL>();
        (*cinfo).q_scale_factor[i as usize] = 100 as ::core::ffi::c_int;
        i += 1;
    }
    i = 0 as ::core::ffi::c_int;
    while i < NUM_HUFF_TBLS {
        (*cinfo).dc_huff_tbl_ptrs[i as usize] = ::core::ptr::null_mut::<JHUFF_TBL>();
        (*cinfo).ac_huff_tbl_ptrs[i as usize] = ::core::ptr::null_mut::<JHUFF_TBL>();
        i += 1;
    }
    (*cinfo).block_size = DCTSIZE;
    (*cinfo).natural_order = &raw const jpeg_natural_order as *const ::core::ffi::c_int;
    (*cinfo).lim_Se = DCTSIZE2 - 1 as ::core::ffi::c_int;
    (*cinfo).script_space = ::core::ptr::null_mut::<jpeg_scan_info>();
...
pub unsafe extern "C" fn jpeg_finish_compress(mut cinfo: j_compress_ptr) {
    ...
    if (*cinfo).global_state == CSTATE_SCANNING || (*cinfo).global_state == CSTATE_RAW_OK {
        if (*cinfo).next_scanline < (*cinfo).image_height {
            (*(*cinfo).err).msg_code = JERR_TOO_LITTLE_DATA as ::core::ffi::c_int;
            Some(
                (*(*cinfo).err)
                    .error_exit
                    .expect("non-null function pointer"),
...
pub unsafe extern "C" fn jpeg_write_marker(
    ...
    let mut write_marker_byte: Option<
        unsafe extern "C" fn(j_compress_ptr, ::core::ffi::c_int) -> (),
    > = None;
    if (*cinfo).next_scanline != 0 as JDIMENSION
    ...
    loop {
        ...
        Some(write_marker_byte.expect("non-null function pointer"))
            .expect("non-null function pointer")(cinfo, *dataptr as ::core::ffi::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn jpeg_write_m_byte(mut cinfo: j_compress_ptr, mut val: ::core::ffi::c_int) {
    Some(
        (*(*cinfo).marker)
            .write_marker_byte
            .expect("non-null function pointer"),
