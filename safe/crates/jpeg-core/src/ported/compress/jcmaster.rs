...
pub struct my_comp_master {
    ...
    pub pass_number: ::core::ffi::c_int,
    pub total_passes: ::core::ffi::c_int,
    pub scan_number: ::core::ffi::c_int,
    pub jpeg_version: *const ::core::ffi::c_char,
}
pub type c_pass_type = ::core::ffi::c_uint;
...
pub const JPEG_MAX_DIMENSION: ::core::ffi::c_long = 65500 as ::core::ffi::c_long;
...
pub const MAX_SAMP_FACTOR: ::core::ffi::c_int = 4 as ::core::ffi::c_int;
...
unsafe extern "C" fn initial_setup(mut cinfo: j_compress_ptr, mut transcode_only: boolean) {
    ...
    let mut samplesperrow: ::core::ffi::c_long = 0;
    let mut jd_samplesperrow: JDIMENSION = 0;
    if transcode_only == 0 {
        jpeg_calc_jpeg_dimensions(cinfo);
    }
    if (*cinfo).jpeg_height <= 0 as JDIMENSION
        || (*cinfo).jpeg_width <= 0 as JDIMENSION
        || (*cinfo).num_components <= 0 as ::core::ffi::c_int
        || (*cinfo).input_components <= 0 as ::core::ffi::c_int
    {
    ...
    if (*cinfo).jpeg_height as ::core::ffi::c_long > JPEG_MAX_DIMENSION
        || (*cinfo).jpeg_width as ::core::ffi::c_long > JPEG_MAX_DIMENSION
    {
        (*(*cinfo).err).msg_code = JERR_IMAGE_TOO_BIG as ::core::ffi::c_int;
        (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] =
            65500 as ::core::ffi::c_long as ::core::ffi::c_uint as ::core::ffi::c_int;
        Some(
            (*(*cinfo).err)
                .error_exit
                .expect("non-null function pointer"),
    ...
    samplesperrow = (*cinfo).image_width as ::core::ffi::c_long
        * (*cinfo).input_components as ::core::ffi::c_long;
    jd_samplesperrow = samplesperrow as JDIMENSION;
    if jd_samplesperrow as ::core::ffi::c_long != samplesperrow {
    ...
    if (*cinfo).data_precision != BITS_IN_JSAMPLE {
        (*(*cinfo).err).msg_code = JERR_BAD_PRECISION as ::core::ffi::c_int;
        (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] = (*cinfo).data_precision;
        Some(
            (*(*cinfo).err)
                .error_exit
                .expect("non-null function pointer"),
    ...
    if (*cinfo).num_components > MAX_COMPONENTS {
        ...
        (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] = (*cinfo).num_components;
        (*(*cinfo).err).msg_parm.i[1 as ::core::ffi::c_int as usize] = 10 as ::core::ffi::c_int;
        Some(
            (*(*cinfo).err)
                .error_exit
                .expect("non-null function pointer"),
    ...
    while ci < (*cinfo).num_components {
        if (*compptr).h_samp_factor <= 0 as ::core::ffi::c_int
            || (*compptr).h_samp_factor > MAX_SAMP_FACTOR
            || (*compptr).v_samp_factor <= 0 as ::core::ffi::c_int
            || (*compptr).v_samp_factor > MAX_SAMP_FACTOR
        {
            (*(*cinfo).err).msg_code = JERR_BAD_SAMPLING as ::core::ffi::c_int;
            Some(
                (*(*cinfo).err)
                    .error_exit
                    .expect("non-null function pointer"),
    ...
    while ci < (*cinfo).num_components {
        ...
        (*compptr).width_in_blocks = jdiv_round_up(
            (*cinfo).jpeg_width as ::core::ffi::c_long
        ...
        (*compptr).height_in_blocks = jdiv_round_up(
            (*cinfo).jpeg_height as ::core::ffi::c_long
        ...
        (*compptr).component_needed = TRUE as boolean;
        ci += 1;
        compptr = compptr.offset(1);
    }
...
unsafe extern "C" fn validate_script(mut cinfo: j_compress_ptr) {
    let mut scanptr: *const jpeg_scan_info = ::core::ptr::null::<jpeg_scan_info>();
    let mut scanno: ::core::ffi::c_int = 0;
    let mut ncomps: ::core::ffi::c_int = 0;
    let mut ci: ::core::ffi::c_int = 0;
    let mut coefi: ::core::ffi::c_int = 0;
    let mut thisi: ::core::ffi::c_int = 0;
    let mut Ss: ::core::ffi::c_int = 0;
    let mut Se: ::core::ffi::c_int = 0;
    let mut Ah: ::core::ffi::c_int = 0;
    let mut Al: ::core::ffi::c_int = 0;
    let mut component_sent: [boolean; 10] = [0; 10];
    let mut last_bitpos_ptr: *mut ::core::ffi::c_int =
        ::core::ptr::null_mut::<::core::ffi::c_int>();
    let mut last_bitpos: [[::core::ffi::c_int; 64]; 10] = [[0; 64]; 10];
    if (*cinfo).num_scans <= 0 as ::core::ffi::c_int {
        (*(*cinfo).err).msg_code = JERR_BAD_SCAN_SCRIPT as ::core::ffi::c_int;
        (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] = 0 as ::core::ffi::c_int;
        Some(
            (*(*cinfo).err)
                .error_exit
                .expect("non-null function pointer"),
    ...
    if (*scanptr).Ss != 0 as ::core::ffi::c_int
        || (*scanptr).Se != DCTSIZE2 - 1 as ::core::ffi::c_int
    {
        (*cinfo).progressive_mode = TRUE as boolean;
        last_bitpos_ptr =
            (&raw mut *(&raw mut last_bitpos as *mut [::core::ffi::c_int; 64])
        ...
        (*cinfo).progressive_mode = FALSE as boolean;
        ci = 0 as ::core::ffi::c_int;
        while ci < (*cinfo).num_components {
            component_sent[ci as usize] = FALSE as boolean;
            ci += 1;
        }
    }
    scanno = 1 as ::core::ffi::c_int;
    while scanno <= (*cinfo).num_scans {
        ncomps = (*scanptr).comps_in_scan;
        if ncomps <= 0 as ::core::ffi::c_int || ncomps > MAX_COMPS_IN_SCAN {
            (*(*cinfo).err).msg_code = JERR_COMPONENT_COUNT as ::core::ffi::c_int;
            (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] = ncomps;
            (*(*cinfo).err).msg_parm.i[1 as ::core::ffi::c_int as usize] = 4 as ::core::ffi::c_int;
            Some(
                (*(*cinfo).err)
                    .error_exit
                    .expect("non-null function pointer"),
        ...
        while ci < ncomps {
            ...
            if thisi < 0 as ::core::ffi::c_int || thisi >= (*cinfo).num_components {
                (*(*cinfo).err).msg_code = JERR_BAD_SCAN_SCRIPT as ::core::ffi::c_int;
                (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] = scanno;
                Some(
                    (*(*cinfo).err)
                        .error_exit
                        .expect("non-null function pointer"),
            ...
            if ci > 0 as ::core::ffi::c_int
                && thisi <= (*scanptr).component_index[(ci - 1 as ::core::ffi::c_int) as usize]
            {
                (*(*cinfo).err).msg_code = JERR_BAD_SCAN_SCRIPT as ::core::ffi::c_int;
                (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] = scanno;
                Some(
        ...
        if (*cinfo).progressive_mode != 0 {
            if Ss < 0 as ::core::ffi::c_int
                ...
                || Se < Ss
                || Se >= DCTSIZE2
                || Ah < 0 as ::core::ffi::c_int
                || Ah > MAX_AH_AL
                || Al < 0 as ::core::ffi::c_int
                || Al > MAX_AH_AL
            {
                (*(*cinfo).err).msg_code = JERR_BAD_PROG_SCRIPT as ::core::ffi::c_int;
                (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] = scanno;
                Some(
                    (*(*cinfo).err)
                        .error_exit
            ...
            } else if ncomps != 1 as ::core::ffi::c_int {
                (*(*cinfo).err).msg_code = JERR_BAD_PROG_SCRIPT as ::core::ffi::c_int;
                (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] = scanno;
                Some(
                    (*(*cinfo).err)
            ...
            ci = 0 as ::core::ffi::c_int;
            while ci < ncomps {
                last_bitpos_ptr = (&raw mut *(&raw mut last_bitpos as *mut [::core::ffi::c_int; 64])
                    .offset(
                        *(&raw const (*scanptr).component_index as *const ::core::ffi::c_int)
                            .offset(ci as isize) as isize,
                    ) as *mut ::core::ffi::c_int)
                    .offset(0 as ::core::ffi::c_int as isize)
                    as *mut ::core::ffi::c_int;
                if Ss != 0 as ::core::ffi::c_int
                    && *last_bitpos_ptr.offset(0 as ::core::ffi::c_int as isize)
                        < 0 as ::core::ffi::c_int
                {
                    (*(*cinfo).err).msg_code = JERR_BAD_PROG_SCRIPT as ::core::ffi::c_int;
                    (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] = scanno;
                ...
                coefi = Ss;
                while coefi <= Se {
                    if *last_bitpos_ptr.offset(coefi as isize) < 0 as ::core::ffi::c_int {
                        if Ah != 0 as ::core::ffi::c_int {
                            (*(*cinfo).err).msg_code = JERR_BAD_PROG_SCRIPT as ::core::ffi::c_int;
                            (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] = scanno;
                            Some(
                                (*(*cinfo).err)
            ...
            if Ss != 0 as ::core::ffi::c_int
                || Se != DCTSIZE2 - 1 as ::core::ffi::c_int
                || Ah != 0 as ::core::ffi::c_int
                || Al != 0 as ::core::ffi::c_int
            {
                (*(*cinfo).err).msg_code = JERR_BAD_PROG_SCRIPT as ::core::ffi::c_int;
            ...
            while ci < ncomps {
                ...
                component_sent[thisi as usize] = TRUE as boolean;
                ci += 1;
            }
        }
    ...
    if (*cinfo).progressive_mode != 0 {
        ci = 0 as ::core::ffi::c_int;
        while ci < (*cinfo).num_components {
            if last_bitpos[ci as usize][0 as ::core::ffi::c_int as usize] < 0 as ::core::ffi::c_int
            {
                (*(*cinfo).err).msg_code = JERR_MISSING_DATA as ::core::ffi::c_int;
                Some(
                    (*(*cinfo).err)
                        .error_exit
                        .expect("non-null function pointer"),
...
pub const MAX_AH_AL: ::core::ffi::c_int = 10 as ::core::ffi::c_int;
unsafe extern "C" fn select_scan_parameters(mut cinfo: j_compress_ptr) {
    ...
    if !(*cinfo).scan_info.is_null() {
        ...
        while ci < (*scanptr).comps_in_scan {
            (*cinfo).cur_comp_info[ci as usize] = (*cinfo).comp_info.offset(
                *(&raw const (*scanptr).component_index as *const ::core::ffi::c_int)
                    .offset(ci as isize) as isize,
        ...
        while ci < (*cinfo).num_components {
            (*cinfo).cur_comp_info[ci as usize] =
                (*cinfo).comp_info.offset(ci as isize) as *mut jpeg_component_info;
            ci += 1;
        }
        (*cinfo).Ss = 0 as ::core::ffi::c_int;
...
unsafe extern "C" fn per_scan_setup(mut cinfo: j_compress_ptr) {
    let mut ci: ::core::ffi::c_int = 0;
    let mut mcublks: ::core::ffi::c_int = 0;
    let mut tmp: ::core::ffi::c_int = 0;
    let mut compptr: *mut jpeg_component_info = ::core::ptr::null_mut::<jpeg_component_info>();
    if (*cinfo).comps_in_scan == 1 as ::core::ffi::c_int {
        compptr = (*cinfo).cur_comp_info[0 as ::core::ffi::c_int as usize];
        (*cinfo).MCUs_per_row = (*compptr).width_in_blocks;
        (*cinfo).MCU_rows_in_scan = (*compptr).height_in_blocks;
        (*compptr).MCU_width = 1 as ::core::ffi::c_int;
        (*compptr).MCU_height = 1 as ::core::ffi::c_int;
        (*compptr).MCU_blocks = 1 as ::core::ffi::c_int;
        (*compptr).MCU_sample_width = DCTSIZE;
        (*compptr).last_col_width = 1 as ::core::ffi::c_int;
        tmp = (*compptr)
            .height_in_blocks
        ...
        (*cinfo).blocks_in_MCU = 1 as ::core::ffi::c_int;
        (*cinfo).MCU_membership[0 as ::core::ffi::c_int as usize] = 0 as ::core::ffi::c_int;
    } else {
        if (*cinfo).comps_in_scan <= 0 as ::core::ffi::c_int
            || (*cinfo).comps_in_scan > MAX_COMPS_IN_SCAN
        {
            (*(*cinfo).err).msg_code = JERR_COMPONENT_COUNT as ::core::ffi::c_int;
            (*(*cinfo).err).msg_parm.i[0 as ::core::ffi::c_int as usize] = (*cinfo).comps_in_scan;
            (*(*cinfo).err).msg_parm.i[1 as ::core::ffi::c_int as usize] = 4 as ::core::ffi::c_int;
            Some(
                (*(*cinfo).err)
                    .error_exit
        ...
        (*cinfo).blocks_in_MCU = 0 as ::core::ffi::c_int;
        ci = 0 as ::core::ffi::c_int;
        while ci < (*cinfo).comps_in_scan {
            ...
            tmp = (*compptr)
                .width_in_blocks
                .wrapping_rem((*compptr).MCU_width as JDIMENSION)
                as ::core::ffi::c_int;
            if tmp == 0 as ::core::ffi::c_int {
            ...
            tmp = (*compptr)
                .height_in_blocks
                .wrapping_rem((*compptr).MCU_height as JDIMENSION)
                as ::core::ffi::c_int;
            if tmp == 0 as ::core::ffi::c_int {
            ...
            if (*cinfo).blocks_in_MCU + mcublks > C_MAX_BLOCKS_IN_MCU {
                (*(*cinfo).err).msg_code = JERR_BAD_MCU_SIZE as ::core::ffi::c_int;
                Some(
                    (*(*cinfo).err)
                        .error_exit
                        .expect("non-null function pointer"),
    ...
    if (*cinfo).restart_in_rows > 0 as ::core::ffi::c_int {
        let mut nominal: ::core::ffi::c_long = (*cinfo).restart_in_rows as ::core::ffi::c_long
            * (*cinfo).MCUs_per_row as ::core::ffi::c_long;
        (*cinfo).restart_interval = (if nominal < 65535 as ::core::ffi::c_long {
            nominal
        } else {
...
unsafe extern "C" fn prepare_for_pass(mut cinfo: j_compress_ptr) {
    ...
    match (*master).pass_type as ::core::ffi::c_uint {
        0 => {
            ...
            .expect("non-null function pointer")(
                cinfo,
                (if (*master).total_passes > 1 as ::core::ffi::c_int {
                    JBUF_SAVE_AND_PASS as ::core::ffi::c_int
                } else {
                    JBUF_PASS_THRU as ::core::ffi::c_int
                }) as J_BUF_MODE,
            );
            Some(
                (*(*cinfo).main)
            ...
            if (*cinfo).optimize_coding != 0 {
                (*master).pub_0.call_pass_startup = FALSE as boolean;
            } else {
                (*master).pub_0.call_pass_startup = TRUE as boolean;
            }
            current_block_34 = 14359455889292382949;
        }
        1 => {
            select_scan_parameters(cinfo);
            per_scan_setup(cinfo);
                ...
                || (*cinfo).arith_code != 0
            {
                ...
                current_block_34 = 11432467037805751825;
            }
        }
        2 => {
            current_block_34 = 11432467037805751825;
    ...
    match current_block_34 {
        11432467037805751825 => {
            ...
            .expect("non-null function pointer")(cinfo, JBUF_CRANK_DEST);
            if (*master).scan_number == 0 as ::core::ffi::c_int {
                Some(
                    (*(*cinfo).marker)
                        .write_frame_header
                        .expect("non-null function pointer"),
    ...
    (*master).pub_0.is_last_pass = ((*master).pass_number
        == (*master).total_passes - 1 as ::core::ffi::c_int)
...
unsafe extern "C" fn pass_startup(mut cinfo: j_compress_ptr) {
    (*(*cinfo).master).call_pass_startup = FALSE as boolean;
    Some(
        (*(*cinfo).marker)
            .write_frame_header
            .expect("non-null function pointer"),
...
pub unsafe extern "C" fn jinit_c_master_control(
    ...
    let mut master: my_master_ptr = ::core::ptr::null_mut::<my_comp_master>();
    master = Some(
        (*(*cinfo).mem)
            .alloc_small
            .expect("non-null function pointer"),
    ...
    .expect("non-null function pointer")(
        cinfo as j_common_ptr,
        JPOOL_IMAGE,
        ::core::mem::size_of::<my_comp_master>() as size_t,
    ) as my_master_ptr;
    (*cinfo).master = master as *mut jpeg_comp_master as *mut jpeg_comp_master;
    (*master).pub_0.prepare_for_pass =
        Some(prepare_for_pass as unsafe extern "C" fn(j_compress_ptr) -> ())
            as Option<unsafe extern "C" fn(j_compress_ptr) -> ()>;
    (*master).pub_0.pass_startup = Some(pass_startup as unsafe extern "C" fn(j_compress_ptr) -> ())
        as Option<unsafe extern "C" fn(j_compress_ptr) -> ()>;
    (*master).pub_0.finish_pass =
        Some(finish_pass_master as unsafe extern "C" fn(j_compress_ptr) -> ())
            as Option<unsafe extern "C" fn(j_compress_ptr) -> ()>;
    (*master).pub_0.is_last_pass = FALSE as boolean;
    initial_setup(cinfo, transcode_only);
    if !(*cinfo).scan_info.is_null() {
        validate_script(cinfo);
    } else {
        (*cinfo).progressive_mode = FALSE as boolean;
        (*cinfo).num_scans = 1 as ::core::ffi::c_int;
    }
    ...
    (*master).scan_number = 0 as ::core::ffi::c_int;
    (*master).pass_number = 0 as ::core::ffi::c_int;
    if (*cinfo).optimize_coding != 0 {
        (*master).total_passes = (*cinfo).num_scans * 2 as ::core::ffi::c_int;
    } else {
